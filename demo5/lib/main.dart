  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          // Menú para cambiar color del AppBar
          PopupMenuButton<int>(
            icon: const Icon(Icons.color_lens), // 🎨 Icono de paleta
            tooltip: 'Cambiar color de la AppBar',
              ...
              return _appBarColors.asMap().entries.map((entry) {
                ...
                return PopupMenuItem<int>(
                  ...
                  child: ListTile(
                    ...
                    title: Text('Color AppBar ${index + 1}'),
                  ),
                );
              }).toList();
            },
          ...
          // Menú para cambiar color del fondo (Scaffold)
          PopupMenuButton<int>(
            icon: const Icon(Icons.format_paint), // 🧱 Icono de fondo
              ...
              return _scaffoldColors.asMap().entries.map((entry) {
                ...
                return PopupMenuItem<int>(
                  ...
                  child: ListTile(
                    ...
                    title: Text('Color Fondo ${index + 1}'),
                  ),
                );
              }).toList();
            },
      ...
      body: GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          if (index == 0) {
            return Center(
              child: Text(
                'Desplázate para ver el efecto del AppBar.',
